...
import nsw.base.core.service.PermissionService;
...
public class PermissionController  extends BaseController{
    ...
    public ResultString addPermissionResources(String permissionId, String[] resourceIds){
		...
		String currUserId = ThreadVariable.getUser().getId();
    ...
    public ResultString create(Permission permission) {
    	...
    	Assert.notNull(permission, ExceptionCode.PERMISSION_IS_NULL.getCode(), ExceptionCode.PERMISSION_IS_NULL.getMsg());
    	ResultString resultString = new ResultString();
    	//初始化返回标志位为失�?
