...
import nsw.base.core.service.PermissionResourceService;
...
public class ResourceController extends BaseController {
	...
	public List<Resource> getResourceByPid(String pid){
		...
		Assert.notNull(pid, ExceptionCode.PERMISSIONID_IS_NULL.getCode(), ExceptionCode.PERMISSIONID_IS_NULL.getMsg());
    ...
    public Set<String> findPermissionsByResourceId(Set<String> resourceIdSet){
		...
		Assert.notNull(resourceIdSet, ExceptionCode.RESOURCEIDSET_IS_NULL.getCode(), ExceptionCode.RESOURCEIDSET_IS_NULL.getMsg());
