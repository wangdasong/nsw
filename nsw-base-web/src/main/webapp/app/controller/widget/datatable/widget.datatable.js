...
// 							}
         				...
         				jQuery(grid_selector).jqGrid('navGrid',pager_selector,
         					...
         					},
         					{
     					        ...
     					        bCancel: "取消",
     					        bClose: "关闭",
     					        url: "/rest/api/" + COMMON.getProviderCode() + tableConfig.editrowurl,
     					        closeAfterEdit: true,
     					        refresh:true,
         						recreateForm: true,
         					...
         					},
         					{
     					        ...
     					        bCancel: "取消",
     					        bClose: "关闭",
     					        url:"/rest/api/"+ COMMON.getProviderCode() + tableConfig.addrowurl,
         						closeAfterAdd: true,
         						recreateForm: true,
         						reloadAfterSubmit:true,
         					...
         					},
         					{
     					        ...
     					        url:"/rest/api/" + COMMON.getProviderCode() + tableConfig.delrowurl,
         						recreateForm: false,
         						beforeShowForm : function(e) {
         							var form = $(e[0]);
